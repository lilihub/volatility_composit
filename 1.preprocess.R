...
original_data_path = '~/Documents/rstudio/volatility1/original_data/'
####### CBT Baseline (csv files in this folder are in the same format) ######
#################### Don't need to run this block every time ############
setwd("original_data/CBT/Baseline")
files = exclude_subjects('CBT/excluded_subs_CBT_BL', 'CBT', original_data_path) # 500->474
...
setwd("~/Documents/rstudio/volatility1/original_data/CBT/Baseline/schedule1")
wrap_up(schedule_path="schedule1", 
        save_path="CBT_baseline_schedule1", ID_length = 6,
        original_data_path)
setwd("~/Documents/rstudio/volatility1/original_data/CBT/Baseline/schedule2")
wrap_up(schedule_path="schedule2", 
        save_path="CBT_baseline_schedule2", ID_length = 6,
        original_data_path)
...
#################### Don't need to run this block every time ############
setwd("~/Documents/rstudio/volatility1/original_data/CBT/FollowUp")
files = exclude_subjects('CBT/excluded_subs_CBT_FU', 'CBT', original_data_path) # 365->339
...
setwd("~/Documents/rstudio/volatility1/original_data/CBT/FollowUp/schedule1")
wrap_up(schedule_path="schedule1", 
        save_path="CBT_followup_schedule1", 
        ID_length = 6,
        original_data_path)
setwd("~/Documents/rstudio/volatility1/original_data/CBT/FollowUp/schedule2")
wrap_up(schedule_path="schedule2", 
        save_path="CBT_followup_schedule2", 
        ID_length = 6,
        original_data_path)
...
setwd("~/Documents/rstudio/volatility1/original_data/SSRI/Baseline")
...
cluster_schedule(files, file_lists)
## wrap up stable and volatile in schedule1 and schedule2
setwd("~/Documents/rstudio/volatility1/original_data/SSRI/Baseline/schedule1")
wrap_up(schedule_path="schedule1", 
        save_path="SSRI_baseline_schedule1", 
        ID_length = 5,
        original_data_path)
setwd("~/Documents/rstudio/volatility1/original_data/SSRI/Baseline/schedule2")
wrap_up(schedule_path="schedule2", 
        save_path="SSRI_baseline_schedule2", 
        ID_length = 5,
        original_data_path)
...
setwd("~/Documents/rstudio/volatility1/original_data/SSRI/FollowUp")
...
cluster_schedule(files, file_lists)
## wrap up stable and volatile in schedule1 and schedule2
setwd("~/Documents/rstudio/volatility1/original_data/SSRI/FollowUp/schedule1")
wrap_up(schedule_path="schedule1", 
        save_path="SSRI_followup_schedule1", 
        ID_length = 5,
        original_data_path)
setwd("~/Documents/rstudio/volatility1/original_data/SSRI/FollowUp/schedule2")
wrap_up(schedule_path="schedule2", 
        save_path="SSRI_followup_schedule2",  
        ID_length = 5,
        original_data_path)
